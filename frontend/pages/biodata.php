...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const preSelectedPositionType = "<?php echo isset($user_data['positionType']) ? $user_data['positionType'] : ''; ?>";
        ...
        // Set pre-selected position type
        if (preSelectedPositionType) {
            positionType.value = preSelectedPositionType;
            populateSupPositions(); // Populate supPosition based on pre-selected type
        }

        // Populate supPosition based on positionType
        function populateSupPositions() {
            const selectedType = positionType.value;
            supPositionSelect.innerHTML = '<option value="">--Select Supervisory Position--</option>';
            positionSelect.innerHTML = '<option value="">--Select Position--</option>';

            if (selectedType && positionAndSupPosition[selectedType]) {
                for (let sup in positionAndSupPosition[selectedType]) {
            ...
            populatePositions(); // Update positions if supPosition is pre-selected
        }

        // Populate Positions based on supPosition
        function populatePositions() {
            const selectedType = positionType.value;
            const selectedSupPosition = supPositionSelect.value;
            positionSelect.innerHTML = '<option value="">--Select Position--</option>';

            if (selectedType && selectedSupPosition && positionAndSupPosition[selectedType][selectedSupPosition]) {
                positionAndSupPosition[selectedType][selectedSupPosition].forEach(position => {
                    let option = document.createElement("option");
        ...
        positionType.addEventListener("change", populateSupPositions);
