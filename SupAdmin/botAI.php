<?php
    function renderPositionSection($totalApplications, $totalGenderCount, $positionData, $index) {
        ?>

        <div id="poition" class="position row">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-7">
                                ...
                                <h5 class="text-light"><?php echo $totalApplications[$positionData] ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <h5 class="text-light"><?php echo $totalGenderCount[$positionData]['Male'] ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <h5 class="text-light"><?php echo $totalGenderCount[$positionData]['Female'] ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php if (!empty($positionData)): ?>
                                <?php foreach ($positionData as $index => $user): // Adding $index here to track iteration ?>
                                    <tr>
                                        ...
                                        <td><button id="btn_<?php echo $positionData['user_id']; ?>-<?php echo $index; ?>" class="btn btn-primary" onclick="toggleDetails('<?php echo $positionData['user_id'];; ?>', <?php echo $index; ?>)">View Details</button> </td>
                                    </tr>
                                    <tr class="details-row" id="details_<?php echo $positionData['user_id']; ?>-<?php echo $index; ?>" style="display:none;">
...
<script>
    ...
    function toggleDetails(positionData, index) {
        // Get the details row by index
        var detailsRow = document.getElementById("details_" + positionData + "-" + index);

        // Get the button
        var button = document.getElementById("btn_" + positionData + "-" + index);
