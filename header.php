<div class="nav">
    ...
    <div class="center-nav" id="mo-cen">
        <ul>
            ...
            <li><a href="Account/session.php" class="<?= ($current_page == 'session.php') ? 'active' : '' ?>">Apply Here</a></li>
            <li><a href="candidate_jor.php" class="<?= ($current_page == 'candidate_jor.php') ? 'active' : '' ?>">Applicant Journey</a></li>
            <li class="relative">
                <a href="#" id="hover-nav">Help
    ...
    <div class="right-nav" id="mo-rig">
        <div class="inline link">
            <a href="Account/session.php" class="<?= ($current_page == 'session.php') ? 'active' : '' ?>">Login</a>
        </div>
    </div>
</div>
