	...
	<div id="auth">
		...
		<div class="row h-100">
			<div id="auth-left" class="col-lg-7 d-none d-lg-block">
				<div class="lg">
					<img class="img-fluid" src="https://edugist.org/unilorin-is-a-terrorist-organisation-says-asuu/unilorin-logo-www-edugist-org/" alt="">
				</div>
			</div>
			<div id="auth-right" class="col-lg-5 col-12">
				<div class="auth-logo ">
					<a href="index.html" class="d-flex">
						<img src="https://edugist.org/unilorin-is-a-terrorist-organisation-says-asuu/unilorin-logo-www-edugist-org/"   alt="Logo">
