<div id="pmc-screen" class="screen" style="display: none;">
                <div class="screen-head">
                    <div class="screen-head-left">
                        <h3>Professional Memberships and Certifications</h3>
                    </div>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            <input type="text" name="" id="addMembershipType" value="">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const addMembershipType = document.getElementById('addMembershipType');
        ...
        pmcAddformSubmit.addEventListener("submit", (e) => {
            ...
            // Validate all fields
            if (addBodyName.value === "" || addMembershipID.value === "" || addMembershipType.value === "" || addMembershipResposibilities.value === "" || addCertificateDate.value === "") {
            ...
            if (rows.length === 1) {
                ...
                membershipType.value = addMembershipType.value;
