            ...
            <div class="position">
                ...
                <div class="select-div">
                    <table>
                        <tr>
                            <td>
                                <select name="position" id="position" value="" onchange="populateSubPositions()">.
                                    <option value="" disabled hidden selected>--select a position--</option>
                                    <option value="Administrative Cadre">Administrative Cadre</option>
                                    ...
                                    <option value="Directorate of COMSIT">Directorate of COMSIT</option>
                                    <option value="Works Unit">Works Unit</option>
                                    <option value="Zoo/Biological Garden">Zoo/Biological Garden</option>
                                    <option value="University Farm">University Farm</option>
                                    <option value="Laboratory">Laboratory</option>
                                    <option value="University School">University School</option>
                                    <option value="Directorate of Security">Directorate of Security</option>
                                    <option value="Academic Planning Unit">Academic Planning Unit</option>
                                    <option value="Sport">Sport</option>
                                    <option value="SIWES">SIWES</option>
                                    <option value="Counselling Center">Counselling Center</option>
                                    <option value="Centre for Supportive Services">Centre for Supportive Services</option>
                                    <option value="Archives Centre">Archives Centre</option>
                            ...
                            <td>
                                <select name="subPosition" id="subPosition" value="">
                                    <option value="" name="" disabled hidden selected>--select sub-position--</option>
                                </select>
                            </td>
                        </tr>
                    </table>
                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <div>
                                <select name="stateOfOrigin" id="state" value="" onchange="populateLGAs()">
                                    <option value="" disabled hidden selected> --select an option--</option>
                                    <option value="Abia" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Abia') ? 'selected' : ''; ?>>Abia</option>
                                    <option value="Adamawa" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Adamawa') ? 'selected' : ''; ?>>Adamawa</option>
                                    <option value="Akwa Ibom" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Akwa Ibom') ? 'selected' : ''; ?>>Akwa Ibom</option>
                                    <option value="Anambra" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Anambra') ? 'selected' : ''; ?>>Anambra</option>
                                    <option value="Bauchi" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Bauchi') ? 'selected' : ''; ?>>Bauchi</option>
                                    <option value="Bayelsa" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Bayelsa') ? 'selected' : ''; ?>>Bayelsa</option>
                                    <option value="Benue" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Benue') ? 'selected' : ''; ?>>Benue</option>
                                    <option value="Borno" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Borno') ? 'selected' : ''; ?>>Borno</option>
                                    <option value="Cross River" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Cross River') ? 'selected' : ''; ?>>Cross River</option>
                                    <option value="Delta" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Delta') ? 'selected' : ''; ?>>Delta</option>
                                    <option value="Ebonyi" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Ebonyi') ? 'selected' : ''; ?>>Ebonyi</option>
                                    <option value="Edo" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Edo') ? 'selected' : ''; ?>>Edo</option>
                                    <option value="Ekiti" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Ekiti') ? 'selected' : ''; ?>>Ekiti</option>
                                    <option value="Enugu" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Enugu') ? 'selected' : ''; ?>>Enugu</option>
                                    <option value="FCT" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'FCT') ? 'selected' : ''; ?>>FCT</option>
                                    <option value="Gombe" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Gombe') ? 'selected' : ''; ?>>Gombe</option>
                                    <option value="Imo" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Imo') ? 'selected' : ''; ?>>Imo</option>
                                    <option value="Jigawa" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Jigawa') ? 'selected' : ''; ?>>Jigawa</option>
                                    <option value="Kaduna" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Kaduna') ? 'selected' : ''; ?>>Kaduna</option>
                                    <option value="Kano" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Kano') ? 'selected' : ''; ?>>Kano</option>
                                    <option value="Katsina" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Katsina') ? 'selected' : ''; ?>>Katsina</option>
                                    <option value="Kebbi" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Kebbi') ? 'selected' : ''; ?>>Kebbi</option>
                                    <option value="Kogi" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Kogi') ? 'selected' : ''; ?>>Kogi</option>
                                    <option value="Kwara" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Kwara') ? 'selected' : ''; ?>>Kwara</option>
                                    <option value="Lagos" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Lagos') ? 'selected' : ''; ?>>Lagos</option>
                                    <option value="Nasarawa" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Nasarawa') ? 'selected' : ''; ?>>Nasarawa</option>
                                    <option value="Niger" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Niger') ? 'selected' : ''; ?>>Niger</option>
                                    <option value="Ogun" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Ogun') ? 'selected' : ''; ?>>Ogun</option>
                                    <option value="Ondo" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Ondo') ? 'selected' : ''; ?>>Ondo</option>
                                    <option value="Osun" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Osun') ? 'selected' : ''; ?>>Osun</option>
                                    <option value="Oyo" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Oyo') ? 'selected' : ''; ?>>Oyo</option>
                                    <option value="Plateau" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Plateau') ? 'selected' : ''; ?>>Plateau</option>
                                    <option value="Rivers" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Rivers') ? 'selected' : ''; ?>>Rivers</option>
                                    <option value="Sokoto" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Sokoto') ? 'selected' : ''; ?>>Sokoto</option>
                                    <option value="Taraba" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Taraba') ? 'selected' : ''; ?>>Taraba</option>
                                    <option value="Yobe" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Yobe') ? 'selected' : ''; ?>>Yobe</option>
                                    <option value="Zamfara" <?php echo (isset($user_data['stateOfOrigin']) && $user_data['stateOfOrigin'] == 'Zamfara') ? 'selected' : ''; ?>>Zamfara</option>
                                </select>
                            </div>
                        </td>
                        <td>
