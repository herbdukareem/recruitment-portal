                        ...
                        <div class="position">
                            ...
                            <div>
                                <select name="position" id="">
                                    <option value="" name="position" disabled hidden selected>--select a position--</option>
                                    <?php foreach ($positions as $category => $roles): ?>
                                        <optgroup label="<?php echo htmlspecialchars($category); ?>">
                                            <?php foreach ($roles as $role): ?>
                                                <option value="<?php echo htmlspecialchars($role); ?>" <?php echo (isset($user_data['position']) && $user_data['position'] == $role) ? 'selected' : ''; ?>>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div>
                                            <select name="lga" id="" Value="">
                                                <option value="" disabled hidden selected> --select an option--</option>
                                                <?php foreach ($lgas as $state => $areas): ?>
                                                <optgroup label="<?php echo $state; ?>">
                                                    <?php foreach ($areas as $area): ?>
                                                        <option value="<?php echo $area; ?>" <?php echo (isset($user_data['lga']) && $user_data['lga'] == $area) ? 'selected' : ''; ?>>
                                                            <?php echo $area; ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </optgroup>
