document.addEventListener("DOMContentLoaded", function(){
    ...
    const pmcButton = document.getElementById("pmc-btn");
    ...
    const pmcScreen = document.getElementById("pmc-screen");
    ...
    bioButton.addEventListener("click", (e)=>{
        ...
        pmcButton.style.background = "none";
        sumButton.style.background = "none";
    ...
    pmcButton.addEventListener("click", (e)=>{
        e.target.style.background = "#ffffff50";
        bioButton.style.background = "none";
        eduButton.style.background = "none";
        workButton.style.background = "none";
